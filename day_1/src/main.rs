...
fn main() {
    ...
    populate_location_id_lists(&grouped_ids, &mut location_id_list_1, &mut location_id_list_2);
    dbg!(calc_total_distance(&location_id_list_1, &location_id_list_2));
    dbg!(calc_similarity_score(&location_id_list_1, &location_id_list_2));
}

fn populate_location_id_lists( grouped_ids: &String, 
    location_id_list_1: &mut Vec<i64>, location_id_list_2: &mut Vec<i64>) {
...
fn calc_total_distance(  location_id_list_1: &Vec<i64>, location_id_list_2: &Vec<i64> ) -> i64 { 
...
fn calc_similarity_score( location_id_list_1: &Vec<i64>, location_id_list_2: &Vec<i64> ) -> i64 {
